...
public class InterviewReviewController {
	...
	@PutMapping("/{assignmentId}/review/{reviewId}")
	public InterviewReviewResponse updateReview(@PathVariable Long assignmentId, @PathVariable Long reviewId,
			@RequestBody InterviewReviewRequest request) {
		return interviewReviewService.updateReview(assignmentId, reviewId, request);
	}

	// ADMIN: delete review
	@DeleteMapping("/{assignmentId}/review/{reviewId}")
	public void deleteReview(@PathVariable Long assignmentId, @PathVariable Long reviewId) {
		interviewReviewService.deleteReview(assignmentId, reviewId);
	}
