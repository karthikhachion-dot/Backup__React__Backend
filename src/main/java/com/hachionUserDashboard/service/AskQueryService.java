...
public class AskQueryService {
	...
	public void saveAskQueryForm(AskQueryWebhookRequest request) throws MessagingException {
...
//	        student.setCourse_name(request.getBlogTitle());
	    ...
	    if (request.getComments() != null && !request.getComments().trim().isEmpty()) {
	        ...
	        history.setRemark(request.getComments());
